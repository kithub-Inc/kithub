                                ...
                                <CardContent>
                                    <div className="grid gap-6 sm:grid-cols-3">
                                        ...
                                        <div className="grid gap-3">
                                            ...
                                            <Select value={subCategory} onValueChange={e => setSubCategory(e)}>
                                ...
                                <CardContent>
                                    <div className="grid gap-6">
                                        <div className="grid gap-3">
                                            ...
                                            <Select value={visibility} onValueChange={(e: `public` | `private`) => setVisibility(e)}>
                                ...
                                <CardContent>
                                    <div className="grid gap-6">
                                        <div className="grid gap-3">
                                            ...
                                            <Select value={license} onValueChange={e => setLicense(e)}>
                                                <SelectTrigger id="status" aria-label="Select status">

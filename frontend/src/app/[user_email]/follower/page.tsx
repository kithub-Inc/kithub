...
import { ChevronLeft, Link2Icon, SquareUserRoundIcon } from 'lucide-react';
                ...
                <div className="mx-auto grid w-full md:max-w-[59rem] px-8 md:px-0 flex-1 auto-rows-max gap-4">
                    ...
                    <div className="mt-5 border p-6 rounded-xl bg-white flex items-center justify-between">
                        <div className="flex items-center">
                            <p onClick={() => router.push(`/${props.params.user_email}/follower`)} className="flex items-center group hover:text-blue-600 cursor-pointer"><SquareUserRoundIcon className="w-4 h-4 mr-2 group-hover:stroke-blue-600" /><span className="font-bold mr-1">팔로워</span> 총 {follower.length}명</p>
                        </div>
                    </div>
